...
INSERT INTO Patrons
VALUES(777, 'Alice Brown', '556 Road Rd');
INSERT INTO Patrons
VALUES(888, 'Dick Chaney', '1 Lonely Rd');
 
INSERT INTO Transactions
VALUES(111, 00010, DATE '2008-10-03', DATE '2008-10-17', DATE '2008-10-02', NULL, NULL);
INSERT INTO Transactions
VALUES(222, 00111, DATE '2010-03-21', DATE '2010-04-04', DATE '2010-03-27', DATE '2010-03-27', 10.00);
INSERT INTO Transactions
VALUES(222, 00110, DATE '2012-04-20', DATE '2012-05-04', DATE '2012-06-20', DATE '2012-06-20', 62.00);
INSERT INTO Transactions
VALUES(444, 00001, DATE '2016-12-8', DATE '2016-12-22', DATE '2017-01-06', NULL, NULL);
INSERT INTO Transactions
...
-- Division query, Join four tables, and query using MINUS
...
SELECT PatronID
FROM Transactions e
WHERE 2=(SELECT COUNT(DISTINCT FeeAmount) FROM Transactions p
WHERE e.FeeAmount<=p.FeeAmount);
...
SELECT T.PatronID
FROM Transactions T
WHERE T.PatronID NOT IN 
    (SELECT T2.PatronID  FROM Transactions T2
    WHERE T2.FeeAmount IS NOT NULL)
ORDER BY T.PatronID;
 
--Outer join query
--List patrons and whether or not they have any transactions
SELECT Patrons.PatronID, Patrons.Name, Transactions.PatronID
FROM Patrons LEFT OUTER JOIN Transactions ON Patrons.PatronID = Transactions.PatronID;
...
-- Test tIC5
INSERT INTO Transactions VALUES (111, 00111, DATE '2016-12-08', DATE '2016-12-22', DATE '2017-01-06', NULL, 120.99);
-- Test tIC2
INSERT INTO Transactions VALUES (111, 01000, DATE '2016-12-08', DATE '2017-01-06', DATE '2017-01-06', NULL, NULL);
